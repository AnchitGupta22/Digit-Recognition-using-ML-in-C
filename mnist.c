...
int main(int argc, char *argv[])
{
    ...
    char str1[20], str2[25], str3[60];

    line(SCALE_X(maxS), SCALE_Y(maxA), 400, 40);
    sprintf(str1, "MAX ACCURACY = %.2f", maxA*100);
    outtextxy(330, 22, str1);

    // avg accuracy
    sprintf(str2, "AVG. ACCURACY = %.2f", avg*100);
    outtextxy(140, 22, str2);

    // execution time
    sprintf(str3, "time taken to execute = %d mins %d secs", ((int)time_taken / 60), ((int)time_taken % 60));
    outtextxy(10, 460, str3);
    // Cleanup
